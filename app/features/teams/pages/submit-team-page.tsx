            ...
            >
                <div className="grid grid-cols-3 w-full gap-10">
                    ...
                    <InputPair
                        ...
                        defaultValue="React Developer, Backend Developer, Product Manager"
                    ...
                    <InputPair
                        ...
                        defaultValue="We are building a new social media platform for dogs to connect with each other"
                        name="description"
                        maxLength={200}
                        type="text"
                        id="description"
