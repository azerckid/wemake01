  ...
  public: {
    Tables: {
      ...
      notifications: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "notifications_product_id_product_product_id_fk"
            columns: ["product_id"]
            isOneToOne: false
      ...
      product_upvotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_upvotes_product_id_product_product_id_fk"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "product"
            referencedColumns: ["product_id"]
    ...
    Enums: {
      ...
      job_type:
        ...
        | "volunteer"
        | "other"
      location_type: "remote" | "on-site" | "hybrid" | "other"
      notification_type: "follow" | "review" | "reply" | "mention"
      product_stage: "idea" | "prototype" | "mvp" | "product"
      roles: "developer" | "designer" | "product-manager" | "founder" | "other"
      salary_range:
        | "less-than-50k"
        | "50k-100k"
        | "100k-150k"
